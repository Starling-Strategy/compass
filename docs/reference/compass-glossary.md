...
| Term | Plain-language meaning | Read more |
| --- | --- | --- |
| **Prompt / instruction** | Text that guides a model's interpretation, bounded judgment, or voice. Truth-bearing rules live in typed contracts and ordinary code instead. | [Prompts and instructions](../02-product-and-answer-flow.md#prompts-and-instructions-where-they-live-how-they-work) |
